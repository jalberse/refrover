...
// TODO - Unfortunately, this loses EXIF rotation data, so images may be rotated incorrectly.
//        See VIZLIB-55. The image crate may be receiving a fix for this soon, linked there.
